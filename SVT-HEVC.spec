...
Source0  : https://github.com/OpenVisualCloud/SVT-HEVC/archive/v1.5.0.tar.gz
...
%prep
%setup -q -n SVT-HEVC-1.5.0
cd %{_builddir}/SVT-HEVC-1.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612286017
mkdir -p clr-build
pushd clr-build
